...
import OrderComponent from "@/components/order-component"; // Import the OrderComponent
    ...
    return (
        <div className="mx-auto max-w-screen-xl md:px-4 px-2">
            ...
            <h1 className="py-4 border-b text-xl font-bold">
                <Link href="/order" className="text-blue hover:underline font-semibold flex items-start gap-2">
                    <LucideArrowLeft /> Order Detail
                </Link>
            </h1>
            <div className="flex justify-between items-center">
                <div>
                    <h2 className="py-2 font-semibold mt-2">Order Status</h2>
                    <span className="border inline-block bg-white border-green-500 text-green-500 p-2 rounded px-4">
                        Delivered
                    </span>
                </div>
